        ...
        {data
          ? data.map((i) => (
              <Grid key={i.id} xs={6} sm={3}>
                <Link href={`/${i.slug}`} style={{ width: '100%' }}>
                
                    <Card variant='bordered' isHoverable>
                      <Card.Header css={{ paddingBottom: 0, minHeight: 40 }}>
                        {i.isNew && (
                      ...
                      <Card.Body css={{ paddingY: isMobile ? '$6' : '$10' }}>
                        <Image
                          width={isXs ? 235 : 100}
                          height={isXs ? 235 : 100}
                          src={i.images[0].url}
...
const Skeleton = () => {
  ...
  return (
    <Card variant='bordered' isHoverable css={{ backgroundColor: '$accents0' }}>
      <Card.Header css={{ paddingBottom: 0, minHeight: 40 }}></Card.Header>
      <Card.Body css={{ paddingY: isMobile ? '$6' : '$10' }}>
        <div
        ...
        {articles
          ? articles.map((i) => (
              <Grid key={i.slug} xs={12} sm={4}>
                <Link href={`article/${i.slug}`} style={{ width: '100%' }}>
      ...
      <UserLayout>
        ...
        <Container md>
          <Grid.Container gap={1} css={{ mt: 50 }}>
            <Grid xs={12} sm={6}>
              <Card variant='bordered' isHoverable>
                <Card.Body css={{ padding: isXs ? 50 : 30 }}>
                  <Row
                    align='center'
