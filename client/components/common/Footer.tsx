        ...
        >
          ...
          <Grid xs={12} sm={4} md={3} direction='column' css={{ p: 20 }}>
            ...
            <div className='contactItem'>
              <MdMeetingRoom color='7828C8' style={{ marginRight: '10px' }} />{' '} Hoc Vien Cong Nghe Buu Chinh Vien Thong -PTIT
            </div>
            <div className='contactItem'>
              <AiFillPhone color='7828C8' style={{ marginRight: '10px' }} /> 0346873207
            </div>
            <div className='contactItem'>
