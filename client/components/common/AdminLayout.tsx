      ...
      <Card.Body>
        ...
        {session &&
          session.roles.some(
            ...
            <>
              <Button
                onPress={() => router.push('/admin/specification')}
                icon={<AiOutlineSetting />}
                light={
                  router.pathname.includes('/admin/specification') ? false : true
                }
                css={{
                  backgroundColor: router.pathname.includes('/admin/specification')
                    ? '$secondary'
                    : '',
                }}
                ripple={false}
